...
write.table(CorrCellMix, "CorrelationTables/CellMixCorrs.tsv", sep = "\t", quote =FALSE, row.names = FALSE)
write.table(CorrPBMC1, "CorrelationTables/PBMC1Corrs.tsv", sep = "\t", quote =FALSE, row.names = FALSE)
write.table(CorrPBMC2, "CorrelationTables/PBMC2Corrs.tsv", sep = "\t", quote =FALSE, row.names = FALSE)
write.table(CorrStromal, "CorrelationTables/StromalCorrs.tsv", sep = "\t", quote =FALSE, row.names = FALSE)
write.table(CorrFram, "CorrelationTables/FramCorrs.tsv", sep = "\t", quote =FALSE, row.names = FALSE)
